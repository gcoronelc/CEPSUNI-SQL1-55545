...
edad int not null check (edad >= 15 and edad <= 60),
...
drop table pc1.dbo.paciente
go

insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(0001,'Augusto Morales', '19980704',23, 72606875);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(0002,'Anabel Lucano', '19980830',23, 73312890);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(0003,'Ivan Guerra', '19970513',24, 72020548);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(0004,'Victoria Luján', '20060717',15, 60411920);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(0005,'Carla Cachay', '19930922',28, 73312891);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(0006,'Flavia Gutierrez', '19960125',25, 72985263);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(0007,'Blanca Sifuentes', '19951103',26, 33327651);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(0008,'Luis Cavero', '19670121',54, 96325413);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(0009,'Ignacio Velez', '20000426',21, 33320201);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00010,'Brenda Damian', '19991023',22, 26548526);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00011,'Renato Hurtado', '19980517',23, 45563870);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00012,'Abelardo Cifuentes', '19841030',37, 53242710);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00013,'Karla rojas', '19890113',32, 58463215);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00014,'Carmen Echevarría', '20001203',21, 79554632);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00015,'Victoria Fuentes', '19790322',42, 68454550);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00016,'Grimanesa Chero', '19981115',23, 72851645);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00017,'Fiorella Campos', '19741223',47, 54129867);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00018,'César Cañote', '19840506',37, 94875329);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00019,'Daniela Santander', '20020830',19, 98412567);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00020,'Anthony Malpartida', '19970126',24, 87459655);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00021,'Luis Diaz', '19950613',26, 72020021);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00022,'Paolo Ruiz', '19870615',34, 72020022);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00023,'Ana Ilave', '19890118',32, 72020023);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00024,'Paola Puentes', '19950825',26, 72020024);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00025,'Pedro Quispe', '19880222',33,72020025);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00026,'Alex Quispe', '19890225',32, 72020026);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00027,'Aron Flores', '19990930',22, 72020027);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00028,'Alexia Chumbe', '19911030',30, 72020028);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00029,'Marcos Piedra', '19850520',36, 72020029);
go
insert into pc1.dbo.paciente(idpac,nom,fecha_nac,edad,dni)
values(00030,'Miguel Bravo', '19970320',24, 72020030);
go
