...
ALTER TABLE USUARIO
	ADD CONSTRAINT CHK_CORREO1 CHECK (CORREO LIKE '%@%.%')
GO

ALTER TABLE USUARIO
	ADD CONSTRAINT CHK_DNI1 CHECK (DNIUSUARIO LIKE '[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]')
GO

ALTER TABLE BIBLIOTECARIA
	ADD CONSTRAINT CHK_CORREO2 CHECK (CORREO LIKE '%@%.%')
GO

ALTER TABLE HISTORIAL
	ADD CONSTRAINT CHK_CODIGO1 CHECK (CODIGOHISTORIAL LIKE '[A-Z][0-9]' OR CODIGOHISTORIAL LIKE '[0-9][A-Z]')
GO

ALTER TABLE USUARIO
	ADD CONSTRAINT UC_USUARIO UNIQUE (CORREO)
GO
